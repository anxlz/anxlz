A better-looking version is to split the projects themselves evenly:
...
- [ ] [`AnxietyEsport`](https://github.com/anxlz/AnxietyEsport)
...
- [ ] [`UniverseMeta`](https://github.com/anxlz/UniverseMeta)
